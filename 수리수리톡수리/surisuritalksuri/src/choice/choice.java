...
public class choice extends JFrame {
	...
	public choice() {
 	   ...
 	   // ★ 라벨에 넣을 아이콘 생성
     ImageIcon suri1 = new ImageIcon(choice.class.getResource("../img/고민수리.png"));
     ImageIcon suri2 = new ImageIcon(choice.class.getResource("../img/오늘수리.png"));
     ImageIcon suri3 = new ImageIcon(choice.class.getResource("../img/운세수리.png"));
     ...
     imgLbl3.setBounds(770, 150, 1000, 700);
